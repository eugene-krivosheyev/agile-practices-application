                        ...
                        .jobs(new Job("make-distr", "MAKEDISTR")
                                ...
                                .tasks(new VcsCheckoutTask()
                                        ...
                                        new MavenTask()
                                                ...
                                                .goal("sonar:sonar")
                                                .environmentVariables("MAVEN_OPTS=\"-Dsonar.host.url=http://84.201.134.115:9000 -Dsonar.login=da6d183f4ddbc06c4fc36c049d181af3f5474fff -Djava.awt.headless=true\"")
                                                .jdk("JDK 1.8")
                                                .executableLabel("Maven 3.6"),
                                        new MavenTask()
